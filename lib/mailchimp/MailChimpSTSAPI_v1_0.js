...
MailChimpSTSAPI_v1_0.prototype.SendEmail = function (params, callback) {
	...
	this.execute('SendEmail', {
		message      : ((params.message !== undefined) ? params.message : null),
		track_opens  : ((params.track_opens !== undefined) ? params.track_opens : null),
		track_clicks : ((params.track_clicks !== undefined) ? params.track_clicks : null),
	    tags         : ((params.tags !== undefined) ? params.tags : null),
	}, callback);
}
