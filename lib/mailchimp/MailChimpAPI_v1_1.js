...
MailChimpAPI_v1_1.prototype.campaigns = function (params, callback) {
	...
	this.execute('campaigns', {
		filter_id : ((params.filter_id !== undefined) ? params.filter_id : null),
		filter_folder : ((params.filter_folder !== undefined) ? params.filter_folder : null),
		filter_fromname : ((params.filter_fromname !== undefined) ? params.filter_fromname : null),
		filter_fromemail : ((params.filter_fromemail !== undefined) ? params.filter_fromemail : null),
		filter_title : ((params.filter_title !== undefined) ? params.filter_title : null),
		filter_subject : ((params.filter_subject !== undefined) ? params.filter_subject : null),
		filter_sendtimestart : ((params.filter_sendtimestart !== undefined) ? params.filter_sendtimestart : null),
		filter_sendtimeend : ((params.filter_sendtimeend !== undefined) ? params.filter_sendtimeend : null),
		filter_exact : ((params.filter_exact !== undefined) ? params.filter_exact : null),
