  ...
  request({
    ...
    if (error) {
      ...
      try {
        ...
        self.emit('error', new Error('Error parsing JSON answer from the MailChimp getAccessToken API.', customParams));
        return;
      }
  ...
  request({
    ...
    if (error) {
      ...
      try {
        ...
        self.emit('error', new Error('Error parsing JSON answer from the MailChimp getMetadata API.'), customParams);
        return;
      }
